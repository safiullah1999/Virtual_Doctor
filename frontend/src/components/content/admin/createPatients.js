...
const validationSchema = Yup.object().shape({
    ...
    contact: Yup.number()
    .required("must enter a contact"),
    gender: Yup.string()
    .required("must enter a gender"),
    email: Yup.string()
        ...
        {({ values,
          ...
          <form style={{ display: "flex" }} onSubmit={handleSubmit}>
            <div style={{ padding:20,width: 400, margin: "auto" ,border :"2px black solid"}}>
              ...
              validateStatus={touched.contact && errors.contact ? "error" : undefined}
              >
              ...
              validateStatus={touched.gender && errors.gender ? "error" : undefined}
              >
...
export default Form.create()(CreatePatients);
